...
class _RedacteursInterfaceState extends State<RedacteursInterface> {
  ...
  Future<void> _ajouterRedacteur() async {
    ...
    final nouveauRedacteur = Redacteur.noId(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Ajout d'un drawer et d'une AppBar personnalisée (rose) avec icône menu
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                // Navigate to the Magazine Home page
                Navigator.of(
                  context,
